    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8"> <!-- Header -->
      <div class="flex items-center justify-between mb-8">
        ...
        <div class="flex space-x-3">
          <button
            :disabled="currentUserPermission < 2 || isTicketLimitReached"
          ...
          <button
            :disabled="exportingData || !tickets.length"
          ...
          >
            <svg v-if="exportingData" class="animate-spin -ml-1 mr-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    ...
                    <tr v-for="ticket in filteredTickets" :key="ticket.id" class="hover:bg-gray-50">
                      <td class="px-4 py-4 min-w-[120px] max-w-[200px]">
                        <div>
                          ...
                          <div v-if="ticket.description" class="text-sm text-gray-500 mt-1 relative group cursor-help">
                            <div class="truncate">
...
v-else
                      ...
                      <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                        <div class="flex items-center justify-center space-x-1">
                          ...
                          >
                            <svg v-if="ticket.active !== false" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              ...
              <p class="mt-1 text-sm text-gray-500">Commencez par ajouter un type de ticket en utilisant le formulaire.
              </p>
            </div>
          </div>
        </div>
